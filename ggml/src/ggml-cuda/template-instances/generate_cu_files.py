...
TYPES_KV = ["GGML_TYPE_F16", "GGML_TYPE_Q4_0", "GGML_TYPE_Q4_1", "GGML_TYPE_Q5_0", "GGML_TYPE_Q5_1", "GGML_TYPE_Q8_0", "GGML_TYPE_BF16", "GGML_TYPE_NVFP4", "GGML_TYPE_MXFP4", "GGML_TYPE_F8_E4M3"]
...
SOURCE_FATTN_MMA_MXFP4_FP8_CASE = "DECL_FATTN_MMA_F16_CASE_MXFP4_FP8({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
...
for ncols in [8, 16, 32, 64]:
    for ncols2 in [1, 2, 4, 8, 16, 32]:
        ...
        with open(f"fattn-mma-f16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            ...
            # MXFP4+FP8 variant (MXFP4 KV routed through the FP8 compute path): head-dim
            # 128 only, ncols2 in {1,2,4,8}.
            if ncols2 in (1, 2, 4, 8):
                f.write(SOURCE_FATTN_MMA_MXFP4_FP8_CASE.format(ncols1=ncols1, ncols2=ncols2, head_size_kq=128, head_size_v=128))
