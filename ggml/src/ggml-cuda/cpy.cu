...
static void ggml_cpy_f32_f8_e4m3_cuda(
    const char * cx, char * cdst, const int64_t ne,
    const int64_t ne00, const int64_t ne01, const int64_t ne02, const int64_t nb00, const int64_t nb01, const int64_t nb02,
    const int64_t nb03, const int64_t ne10, const int64_t ne11, const int64_t ne12, const int64_t nb10, const int64_t nb11, const int64_t nb12, const int64_t nb13, cudaStream_t stream) {

    GGML_ASSERT(ne % QK_F8_E4M3 == 0);
    const int64_t num_blocks = ne / QK_F8_E4M3;
    GGML_ASSERT(num_blocks < UINT_MAX);
    cpy_f32_q<cpy_blck_f32_f8_e4m3, QK_F8_E4M3><<<num_blocks, 1, 0, stream>>>
        (cx, cdst, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13);
}

// F32 -> MXFP4. Unlike NVFP4 (warp-cooperative due to its UE4M3 scale search),
// MXFP4's single closed-form E8M0 scale is cheap, so the generic 1-thread-per-block
// cpy_f32_q path is used -- same as q4_0/q8_0.
...
void ggml_cuda_cpy(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, ggml_tensor * src1) {
    ...
    if (src0->type == src1->type && contiguous_srcs) {
        ...
        // NVFP4 uses a bespoke warp-per-block kernel (its UE4M3 scale search is
        // warp-cooperative); MXFP4 below uses the generic 1-thread-per-block path
        // since its E8M0 scale is closed-form. See ggml_cpy_f32_{nvfp4,mxfp4}_cuda.
        ggml_cpy_f32_nvfp4_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
    } else if (src0->type == GGML_TYPE_F32 && src1->type == GGML_TYPE_F8_E4M3) {
        ggml_cpy_f32_f8_e4m3_cuda
                (src0_ddc, src1_ddc, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, main_stream);
